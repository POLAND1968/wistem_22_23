...
### Graph ----
sep_30_num_meetings <- ggplot(data = sep_30_data, mapping = aes(x = num_meetings)) + 
...
### Graph ----
sep_30_grad_year <- ggplot(data = sep_30_data, mapping = aes(x = graduation_year, fill = graduation_year)) + 
  geom_bar() + 
  scale_fill_manual(values = unique_colors) + 
  geom_text(stat = "count", aes(label = ..count..), position = position_stack(vjust = 0.8)) +  
  labs(title = "Attendance Distribution By Federal Race", x = "Federal Race", y = "Number of Students") + 
...
### Graph ----
sep_30_iep <- ggplot(data = sep_30_data, mapping = aes(x = iep, fill = iep)) + 
  geom_bar() + 
  scale_fill_manual(values = unique_colors) + 
...
### Graph ----
sep_30_plan_504 <- ggplot(data = sep_30_data, mapping = aes(x = program_504, fill = program_504)) + 
  geom_bar() + 
  scale_fill_manual(values = unique_colors) + 
  geom_text(stat = "count", aes(label = ..count..), position = position_stack(vjust = 0.6)) +  
...
### Graph ----
sep_30_esl <- ggplot(data = sep_30_data, mapping = aes(x = esl, fill = esl)) + 
  geom_bar() + 
  scale_fill_manual(values = unique_colors) + 
  geom_text(stat = "count", aes(label = ..count..), position = position_stack(vjust = 0.6)) +  
