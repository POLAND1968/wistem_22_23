...
## Graphs ----
### wieng ----
wieng_race_dist <- ggplot(data = wieng_race, mapping = aes(x = federal_race, y = num_students, fill = federal_race)) + 
  geom_col() + 
  scale_fill_manual(values = unique_colors) + 
  scale_x_discrete(guide = guide_axis(angle = 90)) + 
  labs(
...
### Graphs ----
#### wieng ----
wieng_race_dist_two <- ggplot(data = wieng_race_two, mapping = aes(x = federal_race, y = num_students, fill = federal_race)) + 
  geom_col() + 
  scale_fill_manual(values = unique_colors) + 
  scale_x_discrete(guide = guide_axis(angle = 90)) + 
