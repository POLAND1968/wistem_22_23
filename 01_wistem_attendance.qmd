...
::: {.callout-note icon=false collapse="true"}
## Table for Students Having an IEP or Not
```{r}
# Table
iep_dist %>%
...
::: {.callout-note icon=false collapse="true"}
## Table for Students Having an 504 Plan or Not
```{r}
# Table
program_504_dist %>%
  kbl(caption = "Distribution of Students Having an IEP or Not (Unique)") %>%
...
::: {.callout-note icon=false collapse="true"}
## Table for Students Having ESL or Not
```{r}
# Table
esl_dist %>%
  kbl(caption = "Distribution of Students Having an IEP or Not (Unique)") %>%
